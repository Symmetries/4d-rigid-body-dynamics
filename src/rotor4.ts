...
class Rotor4 {
    ...
    constructor(a : number, b01 : number, b02 : number, b03 : number,
        b12 : number, b13 : number, b23 : number, b0123 : number) {
        this.a = a;
        this.b01 = b01;
        this.b02 = b02;
        this.b03 = b03;
    ...
    rotate(v : Vec4) : Vec4 {
        return new Vec4(
            this.a * this.a * v.x + 2 * this.a * this.b01 * v.y
            ...
            + this.b13 * this.b13 * v.x + this.b23 * this.b23 * v.x,
            this.a * this.a * v.y - 2 * this.a * this.b01 * v.x
            ...
            - 2 * this.b13 * this.b23 * v.z + this.b23 * this.b23 * v.y,
            this.a * this.a * v.z - 2 * this.a * this.b02 * v.x
            ...
            - 2 * this.b13 * this.b23 * v.y - this.b23 * this.b23 * v.z,
            this.a * this.a * v.w - 2 * this.a * this.b03 * v.x
    ...
    rotateBivec(bivec : Bivec4) {

    }

    multLeft(bivec : Bivec4) : Rotor4{
        return new Rotor4(
            -this.b23 * bivec.b23 - this.b13 * bivec.b13
            - this.b12 * bivec.b12 - this.b03 * bivec.b03
            - this.b02 * bivec.b02 - this.b01 * bivec.b01,
            -this.b0123 * bivec.b23 + this.b03 * bivec.b13
            + this.b02 * bivec.b12 - this.b13 * bivec.b03
            - this.b12 * bivec.b02 + this.a * bivec.b01,
            this.b03 * bivec.b23 + this.b0123 * bivec.b13
            - this.b01 * bivec.b12 - this.b23 * bivec.b03
            + this.a * bivec.b02 + this.b12 * bivec.b01,
            -this.b02 * bivec.b23 - this.b01 * bivec.b13
            - this.b0123 * bivec.b12 + this.a * bivec.b03
            + this.b23 * bivec.b02 + this.b13 * bivec.b01,
            this.b13 * bivec.b23 - this.b23 * bivec.b13
            + this.a * bivec.b12 - this.b0123 * bivec.b03
            + this.b01 * bivec.b02 - this.b02 * bivec.b01,
            -this.b12 * bivec.b23 + this.a * bivec.b13
            + this.b23 * bivec.b12 + this.b01 * bivec.b03
            + this.b0123 * bivec.b02 - this.b03 * bivec.b01,
            this.a * bivec.b23 + this.b12 * bivec.b13
            - this.b13 * bivec.b12 + this.b02 * bivec.b03
            - this.b03 * bivec.b02 - this.b0123 * bivec.b01,
            this.b01 * bivec.b23 - this.b02 * bivec.b13
            + this.b03 * bivec.b12 + this.b12 * bivec.b03
            - this.b13 * bivec.b02 + this.b23 * bivec.b01
        );
    }

    add(R : Rotor4, c : number) {
        this.a     += c * R.a;
        this.b01   += c * R.b01;
        this.b02   += c * R.b02;
        this.b03   += c * R.b03;
